...
import { Home, Verify, Track } from './pages';
import { NETWORK_CONFIGS, getCurrentNetworkConfig } from './utils/contractHelpers';
  ...
  return (
    <Router>
      <div className="App">
        ...
        <footer>
          <p>© {new Date().getFullYear()} Agricultural Supply Chain - Public Verification Portal</p>
        </footer>
      </div>
    </Router>
  );
