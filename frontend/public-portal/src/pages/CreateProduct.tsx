...
const CreateProduct: React.FC = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    setFormData(prev => ({
      ...prev,
      [name]: name === 'minCTemperature' || name === 'maxCTemperature' ? Number(value) : value
    }));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(`Error creating product: ${err instanceof Error ? err.message : String(err)}`);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="container">
      ...
      <div className="create-product-form">
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label htmlFor="minCTemperature">Minimum Temperature (°C)</label>
            <input
              type="number"
              id="minCTemperature"
          ...
          <div className="form-group">
            <label htmlFor="maxCTemperature">Maximum Temperature (°C)</label>
            <input
              type="number"
              id="maxCTemperature"
        ...
        <div className="success-message">
          ...
          {createdProductAddress && (
            <div className="created-product-info">
              <p><strong>Product Address:</strong></p>
              <div className="address-container">
                <code>{createdProductAddress}</code>
                <button 
                  className="copy-btn"
                  onClick={() => {
                    navigator.clipboard.writeText(createdProductAddress);
              ...
              <p className="tip-text">Save this address to verify your product later.</p>
            </div>
          )}
        </div>
      )}
